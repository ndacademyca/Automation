# -*- coding: utf-8 -*-
"""
main.py - Send class reminders via Gmail using Google Sheets
Secure version for GitHub Actions
"""
...
def read_google_sheet():
    ...
    try:
        ...
        log_message(f"✅ Sheet read successfully: {len(df)} rows")
        return df
    except Exception as e:
        log_message(f"❌ Google Sheet read error: {e}")
        return None
...
def process_reminders():
    ...
    if df is None:
        log_message("❌ No sheet data — process stopped.")
        return
    ...
    for _, row in df.iterrows():
        ...
        <p><img src="https://raw.githubusercontent.com/ndacademyca/images/main/Whatsapp_notification.png" width="650"></p>
    ...
    log_message(f"🎉 All reminders processed. Total sent: {sent_count}")
